    ...
    return (
        <div className="w-full space-y-10">
            ...
            <div className="flex justify-between items-center">
                <button className="px-8 py-3 border border-gray-400 rounded hover:bg-gray-50 font-medium">
                    Return To Shop
                </button>
                <button className="px-8 py-3 border border-gray-400 rounded hover:bg-gray-50 font-medium">
                    Update Cart
            ...
            <div className="flex flex-col lg:flex-row justify-between gap-10 items-start">
                ...
                {/* Cart Total Box */}
                <div className="border-2 border-black p-6 rounded-md w-full lg:w-96 space-y-4">
                    ...
                    <button className="w-full py-4 bg-[#8B100E] text-white rounded font-medium mt-4">
                        Process to checkout
                    </button>
                </div>
            </div>
